...
(not `clawhub package publish transmitt0r/openclaw-plugin-trilium` — that was a GitHub `owner/repo`
reference valid back when this app was its own standalone repo, not a package slug).
